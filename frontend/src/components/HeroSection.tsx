    ...
    <section className="relative min-h-[calc(100vh-5rem)] flex-1 flex flex-col justify-center py-6 sm:py-10 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center max-w-4xl mx-auto flex flex-col justify-center items-center">
          {/* Top Pill */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 border border-slate-200 text-xs font-semibold text-slate-800 mb-6 hover:bg-slate-200/80 transition-colors">
          ...
          {/* Main Headline */}
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-[#012456] tracking-tight leading-[1.15] text-balance">
          ...
          <p className="mt-4 sm:mt-5 text-base sm:text-lg text-slate-600 font-normal leading-relaxed text-pretty max-w-3xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            ...
            <a
              ...
              className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-white hover:bg-slate-50 text-[#012456] font-bold text-sm transition-all border border-slate-300 shadow-xs hover:border-[#5391FE] flex items-center justify-center gap-2"
            >
